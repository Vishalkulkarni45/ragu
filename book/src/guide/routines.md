...
**Out-of-circuit (unconstrained) execution**: Using the [Emulator](../implementation/drivers/emulator.md) driver, routines call `predict()` to short-circuit execution, performing fast and unconstrained witness computation without enforcing constraints.
